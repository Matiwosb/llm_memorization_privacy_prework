...
def collect_urls():
    ...
    queries = ["AI Powered", "AI", "ChatGPT", "LLM", "Chatbot", "Generative AI", "Artificial Intelligence", "AI-writer", 
               "AI assistant", "AI image generator", "AI avatar maker", "AI photo generator", 
               "AI avatars", "AI art", "AI-Driven", "AI video"]
